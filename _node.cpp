...
/** default constructor */
        ...
        void* node::getVarData() {
            ...
            if (varType == "string") {
                cout << "  Pre-casting, pre-declare vData." << endl;
                vector<string> vData;
                cout << "  declared vData, casting data." << endl;
         ...
         */
         vector<std::string> node::getNodeStrData () {
             const vector<string>* cspData = static_cast<std::vector<string> const*>(ptrData);
             return *cspData;
         }
         vector<std::string> node::getNodeStrData (void* pData) {
             cout << "  pointer call parameter: " << pData << endl;
             const vector<string>* spData = static_cast<std::vector<string> const*>(pData);
             cout << "pointer cast: " << spData << endl;
             return *spData;
         }
		...
		void node::displayNode() {
		    ...
		    cout << "  VarType seen from displayNode: " << varType << endl;
		    cout << "  Address of data vector: " << getPtrData() << endl;
		    if (varType == "int") {
